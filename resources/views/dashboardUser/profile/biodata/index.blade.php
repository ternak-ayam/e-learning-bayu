            ...
            <div
                ...
                <div class="">
                    <div class="flex flex-col p-10">
                        ...
                        <h5 class="mb-10 text-md font-semibold tracking-tight text-gray-900 dark:text-white">089669660660
                        </h5>
                        <p class="font-normal text-gray-700 dark:text-gray-400">Alamat</p>
                        <h5 class="mb-2 text-md font-semibold tracking-tight text-gray-900 dark:text-white">Jalan Bandara
                            Ngurah Rai
                            no 1
                        </h5>
                    </div>
                    ...
                    <div class="flex flex-col items-start justify-start   p-4 leading-normal">
                        ...
                        <div class="flex flex-col md:flex-row w-full justify-center gap-12 p-4">
                            ...
                            <div class="flex w-full flex-col justify-start items-start">
                                <h5 class="mb-2 text-md font-semibold tracking-tight text-gray-900 dark:text-white">Asal
                                    Sekolah
                                </h5>
                                <p class="font-normal text-gray-700 dark:text-gray-400">Universitas Swasta Indonesia</p>
                            </div>
                            <div class="flex w-full flex-col justify-start items-start">
                                <h5 class="mb-2 text-md font-semibold tracking-tight text-gray-900 dark:text-white">Agama
                                </h5>
                                <p class="font-normal text-gray-700 dark:text-gray-400">Atheis</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="flex w-full flex-col justify-start items-start">
                                ...
                                <p class="font-normal text-gray-700 dark:text-gray-400">Denpasar</p>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            <div class="">
                                <a href="{{ url('/profile/biodata/edit-biodata') }}">
                                    <button type="button"
