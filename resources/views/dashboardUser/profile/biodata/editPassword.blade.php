                ...
                <div class="w-full p-4">
                    ...
                    <div class="p-4">
                        <form method="POST" action="{{route('user.update.password', ['user' => Auth::user()->id])}}">
                            ...
                            <button type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Update
                                Password</button>
                        </form>
                    </div>
                </div>
