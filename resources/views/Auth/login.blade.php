...
<head>
    ...
    <title>Login Elearning Kerja Praktek</title>
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-96 m-40 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <i class="fas fa-graduation-cap text-[40px]"></i>
                    <h1 class="text-xl text-center font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                        ELEARNING KERJA PRAKTEK
                    </h1>
                    <form class="space-y-4 md:space-y-6" action="{{route('login')}}" method="POST">
                        ...
                        <button type="submit"
                                style="background: #1f2937" class="w-full text-white  focus:ring-4 focus:outline-none focus:ring-blue-00 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
