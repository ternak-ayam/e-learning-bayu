                ...
                <div class="w-full p-4">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4">
                        <div class="flex gap-2 flex-wrap  items-center">
                            <form action="{{route('admin.filter.materi')}}" method="get" class="flex gap-2">
                                   ...
                                   <th scope="row"
                                    ...
                                    <th scope="row"
                                     ...
                                     <td class="px-6 py-4 flex gap-2 flex-wrap">
                                        <a href="{{route('admin.view.add.materi', ['id' => $materi->id])}}"   class="p-2 rounded bg-green-400"><i class="fa-solid fa-pen text-white"></i></a>
                                        <a href="{{asset('storage/materi/' .  $materi->file)}}" target="blank"  class="p-2 rounded bg-blue-400"><i class="fas fa-eye text-white"></i></a>
                                        <a href="{{route('admin.delete.materi' ,['id' => $materi->id])}}" class="p-2 rounded bg-red-400"><i class="fas fa-trash text-white"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
