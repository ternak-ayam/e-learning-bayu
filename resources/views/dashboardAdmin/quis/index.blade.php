                ...
                <div class="w-full p-4">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4">
                        <div class="flex gap-2 flex-wrap  items-center">
                            <form action="{{route('admin.filter.quis')}}" method="get" class="flex gap-2">
                        ...
                        <div class="w-full flex justify-end">
                            <a href="{{ url('/admin/quis/upload-quis') }}">
                                <button
                                   ...
                                   <th scope="row"
                                    ...
                                    <th scope="row"
                                     ...
                                     <td class="px-6 py-4 flex gap-2 flex-wrap">
                                        ...
                                        <a href="{{route('admin.delete.quis' ,['id' => $quis->id])}}" class="p-2 rounded bg-red-400"><i class="fas fa-trash text-white"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
