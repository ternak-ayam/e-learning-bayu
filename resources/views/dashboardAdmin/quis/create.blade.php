    ...
    <div class="md:px-52 py-10 ">
        ...
        <div class="px-4">
            <div
                ...
                <div class="p-4">
                    <form action="{{$tugas ? route('admin.update.quis' , $tugas->id) :  route('admin.upload.quis')}}" method="POST" enctype="multipart/form-data">
                         @if($tugas)
                        @method('PUT')
                      @endif
                        @csrf
                        <div class="pb-2">
                            ...
                            <input type="text" value="{{$tugas ? $tugas->deskripsi : ''}}" name="deskripsi" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Deskripsi" required="">
                        </div>
                         @error('deskripsi')
                            ...
                            @enderror
                             <div class="pb-2">
                                <label for="username"  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Quis</label>
                                <input type="text" value="{{$tugas ? $tugas->link : ''}}" name="link" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Link Google Form" required="">
                            </div>
                            @error('link')
                                <span class="text-red-700 text-sm" style="color:red">
                                    {{ $message }}
